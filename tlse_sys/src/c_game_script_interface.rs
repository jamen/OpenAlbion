...
pub struct CGameScriptInterfaceVmt {
    pub end_letter_box: extern "fastcall" fn(*mut CGameScriptInterface),
    pub error: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString, c_ulong),
    pub trace_message: extern "fastcall"  fn(*mut CGameScriptInterface, *const CCharString),
    pub validate: extern "fastcall"  fn(*mut CGameScriptInterface),
    pub set_debug_camera_type: extern "fastcall" fn(*mut CGameScriptInterface, c_long),
    pub deactivate_boast_ui: extern "fastcall" fn(*mut CGameScriptInterface),
    pub is_xbox: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub new_script_frame: extern "fastcall" fn(*mut CGameScriptInterface),
    pub start_scripting_entity: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *mut CScriptGameResourceObjectScriptedThingBase, EScriptAIPriority) -> bool,
    pub is_entity_under_scripted_control: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub is_active_thread_terminating: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub is_level_loaded: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_region_loaded: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_region_loaded_and_preloaded: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_region_def_loaded: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub get_region_name: extern "fastcall" fn(*mut CGameScriptInterface) -> *const CCharString,
    pub msg_is_level_loaded: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub msg_is_level_unloaded: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub msg_on_level_loaded: extern "fastcall" fn(*mut CGameScriptInterface, *mut cxx::StdList<CCharString>) -> bool,
    pub msg_on_level_unloaded: extern "fastcall" fn(*mut CGameScriptInterface, *mut cxx::StdList<CCharString>) -> bool,
    pub msg_is_region_loaded: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub msg_is_region_unloaded: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub msg_on_region_loaded: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString) -> bool,
    pub msg_on_region_unloaded: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub msg_on_region_preunloaded: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString) -> bool,
    pub msg_on_quest_completed: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString) -> bool,
    pub msg_on_any_quest_completed: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString) -> bool,
    pub msg_on_quest_failed: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub msg_on_quest_completed_before_screen_shown: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub msg_on_quest_failed_before_screen_shown: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub msg_on_quest_accepted: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString) -> bool,
    pub msg_on_feat_accepted: extern "fastcall" fn(*mut CGameScriptInterface, *mut c_long) -> bool,
    pub msg_is_boast_made: extern "fastcall" fn(*mut CGameScriptInterface, c_long) -> bool,
    pub msg_on_boast_made: extern "fastcall" fn(*mut CGameScriptInterface, *mut c_long, *mut CCharString) -> bool,
    pub msg_on_boasts_made: extern "fastcall" fn(*mut CGameScriptInterface, *mut cxx::StdVector<CCharString>) -> bool,
    pub remove_boast_message: extern "fastcall" fn(*mut CGameScriptInterface),
    pub is_quest_start_screen_active: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString) -> bool,
    pub msg_on_leaving_quest_start_screen: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString) -> bool,
    pub msg_on_leaving_experience_spending_screen: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub msg_is_answered_yes_or_no: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub msg_is_game_info_clicked_past: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub msg_is_tutorial_click_past: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub msg_is_action_mode_button_pressed: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub msg_on_expression_performed: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString) -> bool,
    pub msg_is_cut_scene_skipped: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub remove_all_cut_scene_skipped_messages: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString),
    pub msg_on_hero_hair_type_changed: extern "fastcall" fn(*mut CGameScriptInterface, EClothingCoversArea, *mut CCharString) -> bool,
    pub msg_on_hero_used_teleporter: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString) -> bool,
    pub msg_on_hero_used_guild_seal: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub msg_on_game_saved_manually: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub msg_on_hero_slept: extern "fastcall" fn(*mut CGameScriptInterface, *mut bool) -> bool,
    pub msg_on_hero_fired_ranged_weapon: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub msg_on_hero_cast_spell: extern "fastcall" fn(*mut CGameScriptInterface, *mut EHeroAbility) -> bool,
    pub msg_on_hero_picked_pocket: extern "fastcall" fn(*mut CGameScriptInterface, *mut CScriptThing) -> bool,
    pub msg_on_hero_picked_lock: extern "fastcall" fn(*mut CGameScriptInterface, *mut CScriptThing) -> bool,
    pub msg_on_fishing_game_finished: extern "fastcall" fn(*mut CGameScriptInterface, *mut CScriptThing) -> bool,
    pub msg_on_tavern_game_finished: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub msg_on_hero_rewarded_with_items_from: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString) -> bool,
    pub msg_on_chest_opening_cancelled: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub dont_populate_next_loaded_region: extern "fastcall" fn(*mut CGameScriptInterface),
    pub get_wandering_population_script_def_name_in_current_region: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString),
    pub get_wandering_population_script_def_name_in_region: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *mut CCharString),
    pub is_hero_allowed_henchmen_in_current_region: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub is_hero_allowed_henchmen_in_region: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub post_add_scripted_entities: extern "fastcall" fn(*mut CGameScriptInterface),
    pub is_player_holding_unsheathe_ranged_weapon_button: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub is_player_holding_lock_target_button: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub is_player_holding_fire_ranged_weapon_button: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub is_player_holding_first_person_targeting_button: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub is_hero_in_projectile_weapon_mode: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub register_timer: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub deregister_timer: extern "fastcall" fn(*mut CGameScriptInterface, c_long),
    pub set_timer: extern "fastcall" fn(*mut CGameScriptInterface, c_long, c_long),
    pub get_timer: extern "fastcall" fn(*mut CGameScriptInterface, c_long) -> c_long,
    pub get_hero: extern "fastcall" fn(*mut CGameScriptInterface) -> *mut CScriptThing,
    pub get_hero_targeted_thing: extern "fastcall" fn(*mut CGameScriptInterface) -> CScriptThing,
    pub get_thing_with_script_name: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> CScriptThing,
    pub get_thing_with_script_name_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString) -> CScriptThing,
    pub get_random_thing_with_script_name: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> CScriptThing,
    pub get_all_things_with_script_name: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *mut cxx::StdVector<CScriptThing>) -> c_long,
    pub get_all_creatures_in_area_with_script_name: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const C3DVector, c_float, *const cxx::StdVector<CScriptThing>) -> c_long,
    pub get_nearest_with_script_name: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString) -> CScriptThing,
    pub get_furthest_with_script_name: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString) -> CScriptThing,
    pub get_all_things_with_def_name: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *mut cxx::StdVector<CScriptThing>) -> c_long,
    pub get_all_things_with_def_name_by_distance_from: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString, *mut cxx::StdVector<CScriptThing>) -> c_long,
    pub get_nearest_with_def_name: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString) -> CScriptThing,
    pub get_furthest_with_def_name: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString) -> CScriptThing,
    pub get_thing_with_uid: extern "fastcall" fn(*mut CGameScriptInterface, c_ulong) -> CScriptThing,
    pub get_all_creatures_excluding_hero: extern "fastcall" fn(*mut CGameScriptInterface, *mut cxx::StdVector<CScriptThing>) -> c_long,
    pub get_all_things_in_level: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *mut cxx::StdVector<CScriptThing>) -> c_long,
    pub is_thing_with_this_uid_alive: extern "fastcall" fn(*mut CGameScriptInterface, c_ulong) -> bool,
    pub create_creature: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const C3DVector, *const CCharString, bool) -> CScriptThing,
    pub create_creature_nearby: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const C3DVector, c_float, *const CCharString, bool) -> CScriptThing,
    pub create_creature_on_entity: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CScriptThing, *const CCharString) -> CScriptThing,
    pub turn_creature_into: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString) -> CScriptThing,
    pub set_creature_creation_delay_frames: extern "fastcall" fn(*mut CGameScriptInterface, c_long),
    pub reset_creature_creation_delay_frames: extern "fastcall" fn(*mut CGameScriptInterface),
    pub create_object: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const C3DVector, c_float, *const CCharString) -> CScriptThing,
    pub create_object_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const C3DVector, *const CCharString) -> CScriptThing,
    pub create_object_on_entity: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CScriptThing, *const CCharString) -> CScriptThing,
    pub create_effect: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const C3DVector, *const CCharString, c_float, bool, bool) -> CScriptThing,
    pub create_effect_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CScriptThing, *const CCharString, *const CCharString, bool, bool) -> CScriptThing,
    pub create_light: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, *const CRGBColour, *const CCharString, c_float, c_float, bool) -> CScriptThing,
    pub create_experience_orb: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, c_long) -> CScriptThing,
    pub create_explosion: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const C3DVector, *const C3DVector, CCharString) -> CScriptThing,
    pub create_physical_barrier: extern "fastcall" fn(*mut CGameScriptInterface, c_float, *const C3DVector, *const C3DVector, CCharString) -> CScriptThing,
    pub create_rumble: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, c_float, c_float, CCharString) -> CScriptThing,
    pub clear_all_rumbles: extern "fastcall" fn(*mut CGameScriptInterface),
    pub remove_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool, bool),
    pub show_on_screen_message: extern "fastcall" fn(*mut CGameScriptInterface, *const C2DVector, *const CCharString, *const CRGBColour, *const CCharString),
    pub show_on_screen_message_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString, *const CCharString, c_float),
    pub show_on_screen_message_3: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_float),
    pub add_screen_message: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, ETextGroupSelectionMethod),
    pub add_screen_title_message: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_float, bool),
    pub give_hero_yes_no_question: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString, *const CCharString, *const CCharString, bool),
    pub display_game_info: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub display_game_info_text: extern "fastcall" fn(*mut CGameScriptInterface, *const CWideString),
    pub is_safe_to_display_game_info: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub display_tutorial: extern "fastcall" fn(*mut CGameScriptInterface, ETutorialCategory) -> bool,
    pub is_tutorial_system_enabled: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub give_hero_weapon: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, bool),
    pub give_hero_object: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_long, bool),
    pub set_weapon_as_heros_active_weapon: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub give_hero_item: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub give_hero_items_from_container: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool) -> bool,
    pub take_object_from_hero: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub give_hero_gold: extern "fastcall" fn(*mut CGameScriptInterface, c_long),
    pub get_hero_gold: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub give_hero_experience: extern "fastcall" fn(*mut CGameScriptInterface, c_long),
    pub set_hero_able_to_gain_experience: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub sheathe_hero_weapons: extern "fastcall" fn(*mut CGameScriptInterface),
    pub set_hero_will_as_usable: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_hero_weapons_as_usable: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_weapon_out_crime_enabled: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_guards_ignore_crimes: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub remove_all_hero_weapons: extern "fastcall" fn(*mut CGameScriptInterface),
    pub is_reported_or_unreported_crime_known: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub confiscate_all_hero_items: extern "fastcall" fn(*mut CGameScriptInterface),
    pub confiscate_all_hero_weapons: extern "fastcall" fn(*mut CGameScriptInterface),
    pub confiscate_items_of_type_from_hero: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub return_all_confiscated_items_to_hero: extern "fastcall" fn(*mut CGameScriptInterface),
    pub give_hero_tutorial: extern "fastcall" fn(*mut CGameScriptInterface, ETutorialCategory) -> bool,
    pub make_hero_carry_item_in_hand: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool, bool),
    pub make_hero_carry_item_in_hand_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub add_tattoo_to_hero: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub give_hero_ability: extern "fastcall" fn(*mut CGameScriptInterface, EHeroAbility, bool),
    pub is_player_z_targeting_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub is_player_creature_blocking: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub is_player_creature_ready_to_fire_projectile_weapon: extern "fastcall" fn(*mut CGameScriptInterface, *mut c_float) -> bool,
    pub get_player_creature_combat_multiplier: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_player_creature_combat_multiplier_running_num_hits: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub reset_player_creature_combat_multiplier: extern "fastcall" fn(*mut CGameScriptInterface),
    pub is_player_creature_flourish_enabled: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_player_creature_only_target: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub reset_player_creature_only_target: extern "fastcall" fn(*mut CGameScriptInterface),
    pub respawn_hero: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub give_hero_morality: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub get_hero_morality: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub get_hero_morality_category: extern "fastcall" fn(*mut CGameScriptInterface) -> EMorality,
    pub change_hero_morality_due_to_theft: extern "fastcall" fn(*mut CGameScriptInterface),
    pub change_hero_morality_due_to_picklock: extern "fastcall" fn(*mut CGameScriptInterface),
    pub give_hero_renown_points: extern "fastcall" fn(*mut CGameScriptInterface, c_long),
    pub get_hero_renown_level: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub is_hero_renown_level_full: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub increase_hero_renown_level: extern "fastcall" fn(*mut CGameScriptInterface),
    pub get_hero_strength_level: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_hero_skill_level: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_hero_will_level: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_hero_stat_level: extern "fastcall" fn(*mut CGameScriptInterface, EHeroTrainableStatType) -> c_long,
    pub get_hero_stat_max: extern "fastcall" fn(*mut CGameScriptInterface, EHeroTrainableStatType) -> c_long,
    pub set_hero_age: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub get_hero_age: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub set_hero_as_teenager: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_hero_as_apprentice: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_distance_hero_can_be_heard_from: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub get_hero_rough_experience_level: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_hero_experience_available_to_spend: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_hero_fatness: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub get_hero_scariness: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub get_hero_attractiveness: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub get_hero_will_energy_level: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub set_hero_will_energy_level: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub set_hero_will_energy_as_able_to_refill: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_number_of_items_of_type_in_inventory: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> c_long,
    pub is_object_in_things_possession: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CScriptThing) -> bool,
    pub is_hero_hand_lamp_lit: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_hero_hand_lamp_as_lit: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub is_wearing_clothing_item: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString) -> bool,
    pub is_hero_naked: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub remove_hero_clothing: extern "fastcall" fn(*mut CGameScriptInterface),
    pub set_hero_as_wearing: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub change_hero_hairstyle: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub remove_hero_hairstyle: extern "fastcall" fn(*mut CGameScriptInterface),
    pub is_wearing_hairstyle: extern "fastcall" fn(*mut CGameScriptInterface, *mut CScriptThing, *const CCharString) -> bool,
    pub is_player_carrying_item_of_type: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_player_wielding_weapon: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub is_entity_wielding_weapon: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub is_entity_wielding_melee_weapon: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub is_entity_wielding_ranged_weapon: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub get_previously_wielded_melee_weapon_name: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString) -> bool,
    pub get_previously_wielded_ranged_weapon_name: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString) -> bool,
    pub is_entity_able_to_attack: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub entity_get_thing_in_primary_slot: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> CScriptThing,
    pub apply_hero_penalty_for_death: extern "fastcall" fn(*mut CGameScriptInterface),
    pub give_hero_title: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub get_hero_title: extern "fastcall" fn(*mut CGameScriptInterface) -> EHeroTitle,
    pub entity_set_as_marryable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_as_able_to_region_follow_when_married: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_force_marriage_to_hero: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub is_entity_married_to_hero: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub is_entity_marriable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub get_hero_has_married: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub get_hero_has_current_marriage: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub get_hero_has_divorced_marriage: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub get_hero_has_children: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub get_hero_has_murdered_wife: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub is_hero_child: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub cancel_hero_teleport_effects: extern "fastcall" fn(*mut CGameScriptInterface),
    pub get_number_of_times_hero_has_had_sex: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub set_number_of_times_hero_has_had_sex: extern "fastcall" fn(*mut CGameScriptInterface, c_long),
    pub set_hero_as_having_had_sex: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_hero_as_having_had_gay_sex: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub give_thing_hero_reward_item: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString, *const CCharString),
    pub give_thing_item_in_hand: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString, bool),
    pub give_thing_item_in_slot: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString, *const CCharString),
    pub give_hero_expression: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_long, bool),
    pub hero_has_expression: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_hero_performing_expression: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_d_pad_button_held_for_expression: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub entity_follow_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing, c_float, bool),
    pub entity_stop_following: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub get_following_entity_list: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *mut cxx::StdVector<CScriptThing>) -> bool,
    pub get_perceiving_hero_entity_list: extern "fastcall" fn(*mut CGameScriptInterface, *mut cxx::StdVector<CScriptThing>) -> bool,
    pub get_hero_summoned_creatures_list: extern "fastcall" fn(*mut CGameScriptInterface, *mut cxx::StdVector<CScriptThing>) -> bool,
    pub is_entity_following_hero: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub entity_set_as_allowed_to_follow_hero: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_as_allowed_to_change_region_following_state: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_as_responding_to_follow_and_wait_expressions: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_as_mirroring_hero_enemy_relations_while_following: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub teleport_all_followers_to_hero_position: extern "fastcall" fn(*mut CGameScriptInterface),
    pub entity_teleport_to_hero_position: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub send_entity_event: extern "fastcall" fn(*mut CGameScriptInterface, NEntityEvents::EEventType, *const CScriptThing, *const CScriptThing, *mut CThing),
    pub get_water_height_at_position: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector) -> c_float,
    pub is_fishing_spot_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub disable_fishing_spot: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub update_fish_weight: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub get_best_fish_weight: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> c_float,
    pub hero_go_fishing: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_hero_fishing_level: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub hero_go_digging: extern "fastcall" fn(*mut CGameScriptInterface),
    pub hero_stop_digging: extern "fastcall" fn(*mut CGameScriptInterface),
    pub hero_play_oracle_minigame: extern "fastcall" fn(*mut CGameScriptInterface),
    pub is_hero_playing_oracle_minigame: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub has_hero_won_oracle_minigame: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub hero_play_fireheart_minigame: extern "fastcall" fn(*mut CGameScriptInterface),
    pub hero_quit_fireheart_minigame: extern "fastcall" fn(*mut CGameScriptInterface),
    pub has_hero_force_quit_fireheart_minigame: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub get_hero_health: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub get_hero_health_max: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub get_hero_health_percentage: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub get_hero_will_energy: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_hero_will_energy_max: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_hero_will_energy_percentage: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub change_hero_health_by: extern "fastcall" fn(*mut CGameScriptInterface, c_float, bool, bool),
    pub set_thing_as_killed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub get_health: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> c_float,
    pub modify_thing_health: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float, bool),
    pub entity_set_max_health: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float, bool),
    pub give_hero_new_quest_objective: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_ulong),
    pub tell_hero_quest_objective_completed: extern "fastcall" fn(*mut CGameScriptInterface, c_ulong),
    pub tell_hero_quest_objective_failed: extern "fastcall" fn(*mut CGameScriptInterface, c_ulong),
    pub add_quest_region: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString),
    pub set_quest_world_map_offset: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const C2DCoordI),
    pub is_hero_on_quest: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub hero_receive_message_from_guild_master: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString, bool, bool),
    pub set_guild_master_messages: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub activate_quest: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub activate_multiple_quests: extern "fastcall" fn(*mut CGameScriptInterface, *const CArray<CCharString>),
    pub activate_quest_without_loading_resources: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub activate_multiple_quests_without_loading_resources: extern "fastcall" fn(*mut CGameScriptInterface, *const CArray<CCharString>),
    pub deactivate_quest: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_ulong),
    pub deactivate_quest_later: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_ulong),
    pub prepare_quests_when_final_quest_is_activated: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub prepare_quests_when_final_quest_is_completed: extern "fastcall" fn(*mut CGameScriptInterface),
    pub is_quest_active: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_quest_registered: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_quest_completed: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_quest_failed: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub set_quest_as_completed: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, bool, bool, bool),
    pub set_quest_as_failed: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, bool, *const CWideString, bool),
    pub set_quest_as_persistent: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, bool),
    pub get_exclusive_quest_script_name: extern "fastcall" fn(*mut CGameScriptInterface) -> *const CCharString,
    pub add_quest_card: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString, bool, bool),
    pub remove_quest_card_from_guild: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub remove_quest_card_from_hero: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub give_hero_quest_card_directly: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString, bool),
    pub set_quest_card_objective: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString, *const CCharString, *const CCharString),
    pub set_quest_card_gold_reward: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_long),
    pub set_quest_card_renown_reward: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_long),
    pub remove_all_available_quest_cards_from_guild: extern "fastcall" fn(*mut CGameScriptInterface),
    pub fail_all_active_quests: extern "fastcall" fn(*mut CGameScriptInterface),
    pub get_all_active_quest_info: extern "fastcall" fn(*mut CGameScriptInterface, *mut cxx::StdVector<CCharString>, *mut cxx::StdVector<CCharString>),
    pub add_feat_card: extern "fastcall" fn(*mut CGameScriptInterface, c_long, *const CCharString, *const CCharString),
    pub add_boast: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_long, c_long, c_long, bool, *const CCharString, c_long),
    pub remove_boast: extern "fastcall" fn(*mut CGameScriptInterface, c_long, *const CCharString),
    pub set_boast_as_failed: extern "fastcall" fn(*mut CGameScriptInterface, c_long, *const CCharString),
    pub set_boast_as_completed: extern "fastcall" fn(*mut CGameScriptInterface, c_long, *const CCharString),
    pub is_boast_taken: extern "fastcall" fn(*mut CGameScriptInterface, c_long, *const CCharString) -> bool,
    pub add_log_book_entry: extern "fastcall" fn(*mut CGameScriptInterface, *const CWideString, *const CWideString, *const CWideString, ECategory),
    pub kick_off_quest_start_screen: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, bool, bool),
    pub kick_off_death_screen: extern "fastcall" fn(*mut CGameScriptInterface),
    pub kick_off_credits_screen: extern "fastcall" fn(*mut CGameScriptInterface, *mut CCharString),
    pub set_preferred_quick_access_item: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_long, c_long),
    pub get_death_recovery_marker_name: extern "fastcall" fn(*mut CGameScriptInterface) -> CCharString,
    pub set_death_recovery_marker_name: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub reset_death_recovery_marker_name_to_default: extern "fastcall" fn(*mut CGameScriptInterface),
    pub is_to_fail_quest_on_death: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_whether_to_fail_quest_on_death: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub reset_whether_to_fail_quest_on_death_to_default: extern "fastcall" fn(*mut CGameScriptInterface),
    pub get_most_recent_valid_used_target: extern "fastcall" fn(*mut CGameScriptInterface) -> CScriptThing,
    pub get_most_recent_valid_used_target_name: extern "fastcall" fn(*mut CGameScriptInterface) -> CCharString,
    pub display_quest_info: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_quest_info_name: extern "fastcall" fn(*mut CGameScriptInterface, *const c_char),
    pub set_quest_info_text: extern "fastcall" fn(*mut CGameScriptInterface, *const c_char),
    pub add_quest_info_bar: extern "fastcall" fn(*mut CGameScriptInterface, c_float, c_float, *const CRGBColour, *const CRGBColour, *const CCharString, *const CCharString, c_float) -> c_long,
    pub add_quest_info_bar_health: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CRGBColour, *const CCharString, c_float) -> c_long,
    pub add_quest_info_timer: extern "fastcall" fn(*mut CGameScriptInterface, *const CTimer, *const CCharString, c_float) -> c_long,
    pub add_quest_info_counter: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_long, c_float) -> c_long,
    pub add_quest_info_counter_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CCounter, *const CCharString, c_float) -> c_long,
    pub add_quest_info_counter_list: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_long, c_float) -> c_long,
    pub add_quest_info_tick: extern "fastcall" fn(*mut CGameScriptInterface, EGameAction, bool, c_float) -> c_long,
    pub add_quest_info_tick_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, bool, c_float) -> c_long,
    pub update_quest_info_bar: extern "fastcall" fn(*mut CGameScriptInterface, c_long, c_float, c_float, c_float),
    pub change_quest_info_bar_colour: extern "fastcall" fn(*mut CGameScriptInterface, c_long, *const CRGBColour, *const CRGBColour),
    pub update_quest_info_timer: extern "fastcall" fn(*mut CGameScriptInterface, c_long, c_float),
    pub update_quest_info_counter: extern "fastcall" fn(*mut CGameScriptInterface, c_long, c_long, c_long),
    pub update_quest_info_counter_list: extern "fastcall" fn(*mut CGameScriptInterface, c_long, c_long, c_long),
    pub update_quest_info_tick: extern "fastcall" fn(*mut CGameScriptInterface, c_long, bool),
    pub remove_quest_info_element: extern "fastcall" fn(*mut CGameScriptInterface, c_long),
    pub remove_all_quest_info_elements: extern "fastcall" fn(*mut CGameScriptInterface),
    pub display_time: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub display_money_bag: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub display_mini_game_info: extern "fastcall" fn(*mut CGameScriptInterface, bool, EMiniGameType),
    pub update_mini_game_info_bar: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub is_entity_pick_pocketable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub is_entity_pick_lockable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub is_entity_stealable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub entity_set_as_pick_pocketed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_set_as_pick_locked: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_set_as_stolen: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub mini_map_add_marker: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub mini_map_set_marker_graphic: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub mini_map_remove_marker: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub mini_map_remove_all_markers: extern "fastcall" fn(*mut CGameScriptInterface),
    pub mini_map_allow_route_between_regions: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString, bool),
    pub mini_map_set_as_enabled: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub entity_set_as_hidden_on_mini_map: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_hud_enabled: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub text_entry_exists: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub get_valid_text_entry_name_with_attitude: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString) -> CCharString,
    pub set_thing_has_information: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool, bool, bool),
    pub clear_thing_has_information: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_set_will_be_using_narrator: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub entity_reset_as_pure_ai_narrator: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub add_new_conversation: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool, bool) -> c_long,
    pub add_person_to_conversation: extern "fastcall" fn(*mut CGameScriptInterface, c_long, *const CScriptThing),
    pub add_line_to_conversation: extern "fastcall" fn(*mut CGameScriptInterface, c_long, *const CCharString, bool, *const CScriptThing, *const CScriptThing),
    pub remove_conversation: extern "fastcall" fn(*mut CGameScriptInterface, c_long, bool),
    pub is_conversation_active: extern "fastcall" fn(*mut CGameScriptInterface, c_long) -> bool,
    pub play_avi_movie: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub start_movie_sequence: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *mut CScriptGameResourceObjectMovieBase),
    pub fix_movie_sequence_camera: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub fade_screen_out_until_next_call_to_fade_screen_in: extern "fastcall" fn(*mut CGameScriptInterface, c_float, c_float),
    pub fade_screen_out: extern "fastcall" fn(*mut CGameScriptInterface, c_float, c_float, CRGBColour) -> bool,
    pub fade_screen_in: extern "fastcall" fn(*mut CGameScriptInterface),
    pub is_screen_fading_out: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub pause: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub end_cut_fade: extern "fastcall" fn(*mut CGameScriptInterface),
    pub pause_all_non_scripted_entities: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub pause_all_entities: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_allow_screen_fading_on_next_region_change: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_allow_screen_fading_if_already_faded: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_to_keep_hero_abilities_during_cutscenes: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_to_display_tutorials_during_cutscenes: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_cutscene_mode: extern "fastcall" fn(*mut CGameScriptInterface, bool, bool),
    pub is_in_cutscene: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_cutscene_skippable: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_cutscene_skippable_while_paused: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_cutscene_action_mode: extern "fastcall" fn(*mut CGameScriptInterface, bool, *const CCharString),
    pub preload_new_scene: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub start_progress_display: extern "fastcall" fn(*mut CGameScriptInterface),
    pub stop_progress_display: extern "fastcall" fn(*mut CGameScriptInterface),
    pub set_screen_messages_enabled: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub is_hero_controlled_by_player: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub is_in_movie_sequence: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub cancel_abilities_for_cutscene: extern "fastcall" fn(*mut CGameScriptInterface),
    pub resume_abilities_for_cutscene: extern "fastcall" fn(*mut CGameScriptInterface),
    pub cancel_using_ability: extern "fastcall" fn(*mut CGameScriptInterface, EHeroAbility),
    pub set_ability_availability: extern "fastcall" fn(*mut CGameScriptInterface, EHeroAbility, bool),
    pub set_environmental_effects_always_update: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_dead_creatures_and_experience_orbs_and_drop_bags_as_hidden: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub remove_dead_creature: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub camera_set_camera_preload_flag: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub camera_circle_around_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const C3DVector, c_float),
    pub camera_circle_around_pos: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, *const C3DVector, c_float),
    pub camera_move_to_pos_and_look_at_pos: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, *const C3DVector, c_float),
    pub camera_move_to_pos_and_look_at_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, *const CScriptThing, c_float),
    pub camera_move_between_looking_at: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, *const C3DVector, *const CScriptThing, c_float, c_float),
    pub camera_move_between_looking_at_2: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, *const C3DVector, *const C3DVector, c_float, c_float),
    pub camera_move_between_look_from_and_look_to: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, *const C3DVector, *const C3DVector, *const C3DVector, c_float),
    pub camera_use_camera_point: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const C3DVector, *const CRightHandedSet, c_float, c_long, c_long),
    pub camera_use_camera_point_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const C3DVector, *const CRightHandedSet, c_float, c_long, c_long),
    pub camera_use_camera_point_3: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing, c_float, c_long, c_long),
    pub camera_use_camera_point_4: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CScriptThing, c_float, c_long, c_long),
    pub camera_do_conversation: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing, ECameraOp, bool),
    pub camera_default: extern "fastcall" fn(*mut CGameScriptInterface),
    pub camera_reset_to_view_behind_hero: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub is_camera_in_scripted_mode: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub camera_use_screen_effect: extern "fastcall" fn(*mut CGameScriptInterface, c_float, c_float, c_float),
    pub camera_cancel_screen_effect: extern "fastcall" fn(*mut CGameScriptInterface),
    pub is_camera_pos_on_screen: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector) -> bool,
    pub get_game_angle_xy: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub camera_earthquake_intensity_at_pos: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, c_float, c_float),
    pub camera_shake: extern "fastcall" fn(*mut CGameScriptInterface, c_float, c_float),
    pub open_door: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub close_door: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub open_house_doors: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub close_house_doors: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub jam_door: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub set_door_trigger_type: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, EDoorTriggerType),
    pub override_automatic_house_locking: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_house_owned_by_player: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool, bool),
    pub set_buyable_house_as_scripted: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub is_chest_open: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub open_chest: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool) -> bool,
    pub close_chest: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub get_number_of_keys_needed_to_unlock_chest: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *mut CCharString) -> c_long,
    pub display_locked_chest_message: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub set_trophy_as_mountable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_village_limbo: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_creature_not_reload: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub is_sleeping_time: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub enable_guards: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub enable_villager_def_types: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool, *const CCharString),
    pub try_to_respawn_def_named: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString, *const C3DVector) -> CScriptThing,
    pub clear_hero_enemy_of_guards: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub set_thing_as_usable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_thing_home_building: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub set_village_attitude: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, EScriptVillageAttitude),
    pub add_crime_committed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, ECrime, bool, *const CScriptThing, *const CScriptThing, EOpinionPostDeedType),
    pub give_thing_best_enemy_target: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub clear_thing_best_enemy_target: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_set_in_limbo: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool, bool),
    pub is_entity_in_limbo: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub entity_get_shot_strike_pos: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *mut C3DVector) -> bool,
    pub entity_set_negate_all_hits: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_evade_all_hits: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_able_to_be_engaged_in_combat: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_always_block_attacks_from_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing, bool),
    pub entity_set_attack_thing_immediately: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing, bool, bool),
    pub entity_set_combat_type: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub entity_reset_combat_type_to_default: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_set_max_number_of_attackers: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub entity_clear_max_number_of_attackers: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_attach_to_script: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub entity_set_combat_ability: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float),
    pub entity_set_ranged_target: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub entity_clear_ranged_target: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_set_targetable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_targeting_type: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, ETargetingType),
    pub entity_set_targeting_valid_target_without_los: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_teleport_to_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing, bool),
    pub entity_teleport_to_position: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const C3DVector, c_float, bool, bool),
    pub entity_set_facing_angle: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float, bool),
    pub entity_set_facing_angle_towards_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing, bool),
    pub entity_set_perception_variables: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float, c_float, c_float),
    pub set_thing_persistent: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_thing_as_wanting_money: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub entity_set_appearance_morph_seed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub set_entity_as_region_following: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing, bool),
    pub set_entity_as_following_hero_through_teleporters: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_appearance_seed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_ulong),
    pub entity_get_appearance_seed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *mut c_ulong),
    pub entity_set_as_for_sale: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_stock_item_price: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub entity_get_stock_item_price: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> c_long,
    pub entity_play_object_animation: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString, bool),
    pub entity_set_max_running_speed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float),
    pub entity_set_max_walking_speed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float),
    pub entity_reset_max_running_speed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_reset_max_walking_speed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_attach_to_village: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub entity_set_as_sitting_on_floor: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_as_scared: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_as_drunk: extern "fastcall" fn(*mut CGameScriptInterface, *mut CScriptThing, bool),
    pub entity_set_as_having_bound_hands: extern "fastcall" fn(*mut CGameScriptInterface, *mut CScriptThing, bool),
    pub entity_set_as_remove_all_movement_blocking_modes: extern "fastcall" fn(*mut CGameScriptInterface, *mut CScriptThing),
    pub entity_force_to_look_at_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub entity_force_to_look_at_camera: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_force_to_look_at_nothing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_reset_force_to_look_at: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_set_shot_accuracy_percentage: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub entity_get_standing_on_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> CScriptThing,
    pub entity_get_standing_inside_building: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> CScriptThing,
    pub entity_drop_generic_box: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_sheathe_weapons: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_unsheathe_weapons: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_unsheathe_melee_weapon: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_unsheathe_ranged_weapon: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_alpha: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float, bool),
    pub entity_set_as_drawable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_cutscene_behaviour: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, ECutsceneBehaviour),
    pub entity_get_sex: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> ESex,
    pub entity_set_as_able_to_walk_through_solid_objects: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_as_respond_to_hit: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_as_damageable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_as_killable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool, bool),
    pub entity_set_as_locked: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_decapitate: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_give_gold: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub entity_set_allow_boss_phase_changes: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_get_boss_phase: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> c_long,
    pub entity_set_boss_phase: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub entity_reset_creature_mode: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_set_as_receiving_events: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool) -> bool,
    pub entity_set_as_to_add_to_combo_multiplier_when_hit: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_as_to_add_to_stat_changes_when_hit: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_leave_combat_stance: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_set_as_use_movement_in_actions: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_as_displaying_emote_icon: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_as_collidable_to_things: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_enable_gravity: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_light_as_on: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_fade_out: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float),
    pub entity_fade_in: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float),
    pub entity_begin_loading_animation: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub entity_begin_loading_basic_animations: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_cast_force_push: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool) -> bool,
    pub entity_cast_lightning_at_target: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub begin_loading_mesh: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub entity_will_teleport_to_area: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, C3DVector, c_float, c_float) -> bool,
    pub entity_start_screamer_super_attack_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub entity_end_screamer_super_attack_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub set_hero_guide_to_show_quest_cards_when_spoken_to: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_light_colour: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CRGBColour),
    pub creature_generator_set_family: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub creature_generator_trigger: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub creature_generator_set_always_create_creatures_on_trigger: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub creature_generator_is_depleted: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub creature_generator_is_destroyed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub creature_generator_set_generated_creature_script_name: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub creature_generator_set_num_triggers: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub creature_generator_get_num_generated_creatures: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> c_long,
    pub creature_generator_are_all_creatures_alive: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub creature_generator_add_triggerer: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub creature_generator_remove_triggerer: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub set_creature_generator_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_creature_generators_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, bool),
    pub set_creature_generators_enabled_during_script: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, bool),
    pub set_creature_generators_creature_group_as_enabled: extern "fastcall" fn(*mut CGameScriptInterface, ECreatureGroup, bool),
    pub is_creature_generation_enabled_for_region: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_creature_flying: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub set_teleporter_as_active: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub is_teleporter_active: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub set_teleporting_as_active: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub is_teleporting_active: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_region_exit_as_active: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_region_entrance_as_active: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_region_text_display_as_active: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_hero_sleeping_as_enabled: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub is_hero_sleeping_enabled: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_experience_spending_as_enabled: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_morality_changing_as_enabled: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub set_summoner_death_explosion_affects_hero: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_nearest_enabled_digging_spot: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> CScriptThing,
    pub is_digging_spot_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub is_digging_spot_hidden: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub set_digging_spot_as_hidden: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub check_for_camera_message: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub wait_for_camera_message: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub set_thing_as_conscious: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool, *const CCharString),
    pub set_fire_to_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub extinguish_fires_on_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub is_thing_on_fire: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub add_item_to_container: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub remove_item_from_container: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub entity_set_death_container_as_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub get_item_def_names_from_container: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *mut cxx::StdVector<CCharString>),
    pub set_creature_brain: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub entity_set_stategroup_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString, bool),
    pub entity_set_all_stategroups_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_combat_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_sleep_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_opinion_reactions_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_set_deed_reactions_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub debug_get_all_text_entries_for_targeted_thing: extern "fastcall" fn(*mut CGameScriptInterface, *mut cxx::StdSet<c_ulong>),
    pub entity_set_thing_as_enemy_of_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub entity_unset_thing_as_enemy_of_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub entity_set_thing_as_ally_of_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub entity_unset_thing_as_ally_of_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub entity_set_in_faction: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub set_faction_as_allied_to_faction: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString),
    pub set_faction_as_neutral_to_faction: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString),
    pub set_faction_as_enemy_to_faction: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString),
    pub are_entities_enemies: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing) -> bool,
    pub get_next_in_opinion_attitude_graph: extern "fastcall" fn(*mut CGameScriptInterface, EOpinionAttitudeType) -> EOpinionAttitudeType,
    pub get_opinion_attitude_as_string: extern "fastcall" fn(*mut CGameScriptInterface, EOpinionAttitudeType, *mut CCharString),
    pub entity_get_opinion_attitude_to_player: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> EOpinionAttitudeType,
    pub entity_get_opinion_attitude_to_player_as_string: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *mut CCharString),
    pub entity_get_opinion_of_player: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, EOpinion) -> c_float,
    pub entity_set_opinion_reaction_mask: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub entity_set_opinion_reaction_mask_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub entity_set_opinion_deed_mask: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub entity_set_opinion_deed_mask_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub entity_set_opinion_deed_type_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, EOpinionDeedType, bool),
    pub entity_set_opinion_attitude_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, EOpinionAttitudeType, bool),
    pub entity_set_opinion_reaction_enabled: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, EOpinionReactionType, bool),
    pub entity_set_personality_override: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub entity_set_personality_override_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub entity_clear_personality_override: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub entity_set_as_opinion_source: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub entity_set_as_opinion_source_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub entity_unset_as_opinion_source: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub opinion_source_set_as_exclusive: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub opinion_source_set_as_attention_grabbing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub entity_post_opinion_deed_to_all: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, EOpinionDeedType),
    pub entity_post_opinion_deed_to_recipient: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, EOpinionDeedType, *const CScriptThing),
    pub entity_post_opinion_deed_to_recipient_village: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, EOpinionDeedType, *const CScriptThing),
    pub entity_post_opinion_deed_keep_searching_for_witnesses: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, EOpinionDeedType, *const CScriptThing) -> c_long,
    pub remove_opinion_deed_still_searching_for_witnesses: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_long),
    pub is_deed_witnessed: extern "fastcall" fn(*mut CGameScriptInterface, c_long) -> bool,
    pub can_thing_be_seen_by_other_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing) -> bool,
    pub can_thing_be_nearly_seen_by_other_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing) -> bool,
    pub can_thing_be_smelled_by_other_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing) -> bool,
    pub can_thing_be_heard_by_other_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing) -> bool,
    pub is_thing_aware_of_other_thing_in_any_way: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing) -> bool,
    pub entity_set_as_aware_of_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing),
    pub entity_set_sound_radius: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float),
    pub entity_set_smell_radius: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float),
    pub entity_set_sight_radius: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float),
    pub entity_set_extended_sight_radius: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float),
    pub entity_set_give_up_chase_radius: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, c_float),
    pub entity_get_hearing_radius: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> c_float,
    pub manually_trigger_trap: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub manually_reset_trap: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub set_time_of_day: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub get_time_of_day: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub set_time_as_stopped: extern "fastcall" fn(*mut CGameScriptInterface, bool, *mut c_long),
    pub fast_forward_time_to: extern "fastcall" fn(*mut CGameScriptInterface, c_float, c_float),
    pub is_time_of_day_between: extern "fastcall" fn(*mut CGameScriptInterface, c_long, c_long) -> bool,
    pub get_day_of_week: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_day_count: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_world_frame: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_constant_fps: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_active_quest_name: extern "fastcall" fn(*mut CGameScriptInterface) -> CCharString,
    pub transition_to_theme: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_float),
    pub reset_to_default_theme: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub transition_to_theme_all_internals: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_float),
    pub reset_to_default_theme_all_internals: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub transition_to_theme_externals: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_float),
    pub reset_to_default_theme_externals: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub set_environment_theme_weight_all_channels: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_float),
    pub set_environment_theme_weight_all_internals: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_float),
    pub set_environment_theme_weight_externals: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, c_float),
    pub set_sound_themes_as_enabled_for_region: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, bool),
    pub set_all_sounds_as_muted: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub radial_blur_fade_to: extern "fastcall" fn(*mut CGameScriptInterface, c_float, c_float, c_float, c_float, c_float, c_float, c_float) -> *mut c_void,
    pub radial_blur_fade_to_2: extern "fastcall" fn(*mut CGameScriptInterface, c_float, C3DVector, c_float, C3DVector, c_float, c_float, c_float) -> *mut c_void,
    pub radial_blur_fade_out: extern "fastcall" fn(*mut CGameScriptInterface, c_float, *mut c_void),
    pub is_radial_blur_fade_active: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub cancel_radial_blur_fade: extern "fastcall" fn(*mut CGameScriptInterface),
    pub radial_blur_set_center_world_pos: extern "fastcall" fn(*mut CGameScriptInterface, *mut c_void, *const C3DVector),
    pub displacement_monochrome_effect_colour_fade_to: extern "fastcall" fn(*mut CGameScriptInterface, c_float, *const CRGBFloatColour) -> c_void,
    pub displacement_monochrome_effect_colour_fade_out: extern "fastcall" fn(*mut CGameScriptInterface, c_float, *mut c_void),
    pub screen_filter_fade_to: extern "fastcall" fn(*mut CGameScriptInterface, c_float, c_float, c_float, c_float, c_float, *const CRGBFloatColour, *const cxx::StdVector<CScreenFilterSThingByPass>) -> c_void,
    pub screen_filter_fade_out: extern "fastcall" fn(*mut CGameScriptInterface, c_float, *mut c_void),
    pub set_thing_and_carried_items_not_affected_by_screen_filter: extern "fastcall" fn(*mut CGameScriptInterface, *mut CScriptThing, *mut c_void),
    pub un_set_thing_and_carried_items_not_affected_by_screen_filter: extern "fastcall" fn(*mut CGameScriptInterface, *mut CScriptThing),
    pub is_gift_romantic: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_gift_friendly: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_gift_offensive: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> bool,
    pub is_thing_a_bed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub is_thing_a_chest: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub is_thing_a_door: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub is_thing_smashable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub is_thing_searchable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub apply_script_brush: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub enable_decals: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub play_criteria_sound_on_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString) -> c_ulong,
    pub play_sound_on_thing: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString) -> c_ulong,
    pub is_sound_playing: extern "fastcall" fn(*mut CGameScriptInterface, c_ulong) -> bool,
    pub stop_sound: extern "fastcall" fn(*mut CGameScriptInterface, c_ulong),
    pub play_sound_at_pos: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, *const CCharString) -> c_ulong,
    pub play_2d_sound: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> c_ulong,
    pub enable_sounds: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub override_music: extern "fastcall" fn(*mut CGameScriptInterface, EMusicSetType, bool, bool),
    pub stop_override_music: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub cache_music_set: extern "fastcall" fn(*mut CGameScriptInterface, EMusicSetType),
    pub enable_danger_music: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub is_danger_music_enabled: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub start_countdown_timer: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub get_countdown_timer: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub auto_save_check_point: extern "fastcall" fn(*mut CGameScriptInterface),
    pub auto_save_quest_start: extern "fastcall" fn(*mut CGameScriptInterface),
    pub auto_save: extern "fastcall" fn(*mut CGameScriptInterface),
    pub set_saving_as_enabled: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub is_saving_enabled: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_save_game_marker_pos: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector),
    pub reset_to_front_end: extern "fastcall" fn(*mut CGameScriptInterface),
    pub set_guild_seal_recall_location: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, c_float),
    pub get_guild_seal_recall_pos: extern "fastcall" fn(*mut CGameScriptInterface) -> C3DVector,
    pub get_guild_seal_recall_angle_xy: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub set_readable_object_text: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CWideString),
    pub set_readable_object_text_tag: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub get_formatted_string: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const cxx::StdVector<CWideString>) -> CWideString,
    pub get_text_string: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString) -> CWideString,
    pub add_rumour_category: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub add_new_rumour_to_category: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString),
    pub remove_rumour_category: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString),
    pub set_category_activity: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, bool),
    pub add_gossip_village: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString),
    pub add_gossip_faction_to_category: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, *const CCharString),
    pub set_is_gossip_for_player: extern "fastcall" fn(*mut CGameScriptInterface, CCharString, bool),
    pub set_is_gossip_for_player_2: extern "fastcall" fn(*mut CGameScriptInterface, *const CCharString, bool),
    pub update_online_score_archery: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub update_online_score_chicken_kick: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub update_online_score_chapel_or_temple: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub update_online_score_fishing_compo: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub update_score_fishing_competition: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub get_best_time_pairs: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub get_best_time_sorting: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub get_best_score_blackjack: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_best_score_coin_golf_oak_vale: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_best_score_coin_golf_snow_spire: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_best_score_shove_ha_penny: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub get_best_time_guess_the_addition: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub is_hero_in_tavern_game: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub get_num_houses_owned: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub start_sneaking: extern "fastcall" fn(*mut CGameScriptInterface),
    pub get_steal_duration: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> c_long,
    pub set_useable_by_hero: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_owned_by_hero: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_tavern_table_available_for_use: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_is_thing_turncoatable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_is_thing_force_pushable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_is_thing_lightningable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub set_is_thing_epic_spellable: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub is_thing_turncoated: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing) -> bool,
    pub add_creature_scripted_mode: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CCharString),
    pub remove_creature_scripted_mode: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub force_ships_visible: extern "fastcall" fn(*mut CGameScriptInterface),
    pub get_sleeping_position_and_orientation_from_bed: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, *const CScriptThing, *mut C3DVector, *mut C3DVector) -> bool,
    pub set_bed_availability: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool),
    pub repopulate_village: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing),
    pub smash_all_windows_within_radius_of_point: extern "fastcall" fn(*mut CGameScriptInterface, *const C3DVector, c_float),
    pub set_residency: extern "fastcall" fn(*mut CGameScriptInterface, *const CScriptThing, bool) -> CScriptThing,
    pub set_thanking_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_ulong),
    pub get_thanking_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_ulong,
    pub reset_thanking_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_ignoring_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_ulong),
    pub get_ignoring_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_ulong,
    pub reset_ignoring_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_wander_centre_point: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, C3DVector),
    pub get_wander_centre_point: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> C3DVector,
    pub reset_wander_centre_point: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_wander_min_distance: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_float),
    pub get_wander_min_distance: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_float,
    pub reset_wander_min_distance: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_wander_max_distance: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_float),
    pub get_wander_max_distance: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_float,
    pub reset_wander_max_distance: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_gossip_counter: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_long),
    pub get_gossip_counter: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_long,
    pub reset_gossip_counter: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_max_gossip_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_long),
    pub get_max_gossip_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_long,
    pub reset_max_gossip_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_warning_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_ulong),
    pub get_warning_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_ulong,
    pub reset_warning_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_beer_request_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_ulong),
    pub get_beer_request_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_ulong,
    pub reset_beer_request_phrase: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_scripting_state_group: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, EScriptingStateGroups),
    pub get_scripting_state_group: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> EScriptingStateGroups,
    pub reset_scripting_state_group: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_max_hero_reaction_distance: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_float),
    pub get_max_hero_reaction_distance: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_float,
    pub reset_max_hero_reaction_distance: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_action_frequency: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_long),
    pub get_action_frequency: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_long,
    pub reset_action_frequency: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_action_frequency_variation: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_float),
    pub get_action_frequency_variation: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_float,
    pub reset_action_frequency_variation: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_action: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, CCharString),
    pub get_action: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> CCharString,
    pub reset_action: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_face_hero_for_action: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, bool),
    pub get_face_hero_for_action: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> bool,
    pub reset_face_hero_for_action: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_target_name: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, CCharString),
    pub get_target_name: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> CCharString,
    pub reset_target_name: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_follow_distance: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_float),
    pub get_follow_distance: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_float,
    pub reset_follow_distance: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_attack_hero_on_sight: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, bool),
    pub get_attack_hero_on_sight: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> bool,
    pub reset_attack_hero_on_sight: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_time_to_spend_harassing_hero: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_long),
    pub get_time_to_spend_harassing_hero: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_long,
    pub reset_time_to_spend_harassing_hero: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_combat_nearby_enemy_fleeing_break_off_range: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_float),
    pub get_combat_nearby_enemy_fleeing_break_off_range: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_float,
    pub reset_combat_nearby_enemy_fleeing_break_off_range: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_combat_nearby_break_off_range: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_float),
    pub get_combat_nearby_break_off_range: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_float,
    pub reset_combat_nearby_break_off_range: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_steal_stealable_items: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, bool),
    pub get_steal_stealable_items: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> bool,
    pub reset_steal_stealable_items: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_recover_stealable_items: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, bool),
    pub get_recover_stealable_items: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> bool,
    pub reset_recover_stealable_items: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_take_stealable_item_to_random_destination: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, bool),
    pub get_take_stealable_item_to_random_destination: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> bool,
    pub reset_take_stealable_item_to_random_destination: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_kill_self_and_stealable_item_after_reaching_destination: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, bool),
    pub get_kill_self_and_stealable_item_after_reaching_destination: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> bool,
    pub reset_kill_self_and_stealable_item_after_reaching_destination: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_allowed_to_follow: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, bool),
    pub get_allowed_to_follow: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> bool,
    pub reset_allowed_to_follow: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_table_name: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, CCharString),
    pub get_table_name: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> CCharString,
    pub reset_table_name: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_seat_name: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, CCharString),
    pub get_seat_name: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> CCharString,
    pub reset_seat_name: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_disable_head_looking: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, bool),
    pub get_disable_head_looking: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> bool,
    pub reset_disable_head_looking: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_is_pushable_by_hero: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, bool),
    pub get_is_pushable_by_hero: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> bool,
    pub reset_is_pushable_by_hero: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_look_for_finite_time: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, bool),
    pub get_look_for_finite_time: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> bool,
    pub reset_look_for_finite_time: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_avoid_region_exits: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, bool),
    pub get_avoid_region_exits: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> bool,
    pub reset_avoid_region_exits: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_targeting_distance_offset: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing, c_float),
    pub get_targeting_distance_offset: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing) -> c_float,
    pub reset_targeting_distance_offset: extern "fastcall" fn(*mut CGameScriptInterface, CScriptThing),
    pub set_player_using_melee_dummies: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_player_using_melee_dummies: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_player_using_ranged_dummies: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_player_using_ranged_dummies: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_player_using_will_dummies: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_player_using_will_dummies: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_cheap_head_looking: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_cheap_head_looking: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_quit_tavern_game: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_quit_tavern_game: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_prize_tavern_table: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_prize_tavern_table: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_betting_active: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_betting_active: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_betting_accept: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_betting_accept: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_betting_amount: extern "fastcall" fn(*mut CGameScriptInterface, c_long),
    pub get_betting_amount: extern "fastcall" fn(*mut CGameScriptInterface) -> c_long,
    pub set_count_bet_money_down: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_count_bet_money_down: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_spot_the_addition_beaten: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_spot_the_addition_beaten: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_global_targeting_distance_offset: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub get_global_targeting_distance_offset: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub set_trading_price_mult: extern "fastcall" fn(*mut CGameScriptInterface, c_float),
    pub get_trading_price_mult: extern "fastcall" fn(*mut CGameScriptInterface) -> c_float,
    pub set_boasting_enabled: extern "fastcall" fn(*mut CGameScriptInterface, bool),
    pub get_boasting_enabled: extern "fastcall" fn(*mut CGameScriptInterface) -> bool,
    pub set_active_gossip_categories: extern "fastcall" fn(*mut CGameScriptInterface, CCharString, bool),
    pub get_active_gossip_categories: extern "fastcall" fn(*mut CGameScriptInterface) -> *const cxx::StdMap<CCharString, bool>,
    pub get_active_gossip_categories_2: extern "fastcall" fn(*mut CGameScriptInterface, CCharString) -> *mut bool,
    pub get_active_gossip_categories_size: extern "fastcall" fn(*mut CGameScriptInterface) -> i32,
    pub clear_active_gossip_categories: extern "fastcall" fn(*mut CGameScriptInterface),
    pub get_is_gossip_for_player: extern "fastcall" fn(*mut CGameScriptInterface) -> *const cxx::StdMap<CCharString, bool>,
    pub get_is_gossip_for_player_2: extern "fastcall" fn(*mut CGameScriptInterface, CCharString) -> *mut bool,
    pub get_is_gossip_for_player_size: extern "fastcall" fn(*mut CGameScriptInterface) -> i32,
    pub clear_is_gossip_for_player: extern "fastcall" fn(*mut CGameScriptInterface),
    pub set_gossip: extern "fastcall" fn(*mut CGameScriptInterface, CCharString, CCharString, c_long),
    pub get_gossip: extern "fastcall" fn(*mut CGameScriptInterface, CCharString) -> *const cxx::StdVector<CCharString>,
    pub get_gossip_2: extern "fastcall" fn(*mut CGameScriptInterface, CCharString, c_long) -> CCharString,
    pub get_gossip_size: extern "fastcall" fn(*mut CGameScriptInterface, CCharString) -> i32,
    pub clear_gossip: extern "fastcall" fn(*mut CGameScriptInterface, CCharString),
    pub remove_gossip: extern "fastcall" fn(*mut CGameScriptInterface, CCharString),
    pub add_gossip: extern "fastcall" fn(*mut CGameScriptInterface, CCharString),
    pub add_gossip_2: extern "fastcall" fn(*mut CGameScriptInterface, CCharString, CCharString),
    pub set_gossip_villages: extern "fastcall" fn(*mut CGameScriptInterface, CCharString, CCharString, c_long),
    pub get_gossip_villages: extern "fastcall" fn(*mut CGameScriptInterface, CCharString) -> *const cxx::StdVector<CCharString>,
    pub get_gossip_villages_2: extern "fastcall" fn(*mut CGameScriptInterface, CCharString, c_long) -> CCharString,
    pub get_gossip_villages_size: extern "fastcall" fn(*mut CGameScriptInterface, CCharString) -> i32,
    pub clear_gossip_villages: extern "fastcall" fn(*mut CGameScriptInterface, CCharString),
    pub remove_gossip_villages: extern "fastcall" fn(*mut CGameScriptInterface, CCharString),
    pub add_gossip_villages: extern "fastcall" fn(*mut CGameScriptInterface, CCharString),
    pub add_gossip_villages_2: extern "fastcall" fn(*mut CGameScriptInterface, CCharString, CCharString),
    pub set_gossip_factions: extern "fastcall" fn(*mut CGameScriptInterface, CCharString, CCharString, c_long),
    pub get_gossip_factions: extern "fastcall" fn(*mut CGameScriptInterface, CCharString) -> *const cxx::StdVector<CCharString>,
    pub get_gossip_factions_2: extern "fastcall" fn(*mut CGameScriptInterface, CCharString, c_long) -> CCharString,
    pub get_gossip_factions_size: extern "fastcall" fn(*mut CGameScriptInterface, CCharString) -> i32,
    pub clear_gossip_factions: extern "fastcall" fn(*mut CGameScriptInterface, CCharString),
    pub remove_gossip_factions: extern "fastcall" fn(*mut CGameScriptInterface, CCharString),
    pub add_gossip_factions: extern "fastcall" fn(*mut CGameScriptInterface, CCharString),
    pub add_gossip_factions_2: extern "fastcall" fn(*mut CGameScriptInterface, CCharString, CCharString),
    pub c_game_script_interface_destructor: extern "fastcall" fn(*mut CGameScriptInterface),
}
